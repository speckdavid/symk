...
const MEDDLY::binary_opname *USER_OPS::LESSTHAN;
...
class USER_OPS::LessThan : public MEDDLY::binary_operation
{
public:
  LessThan(const MEDDLY::binary_opname *code, MEDDLY::expert_forest *arg1,
...
protected:
                      ...
                      MEDDLY::node_handle &c)
  {
    ...
    {
      c = -1;
      cev = isless(aev, bev) ? 1 : 0;
      return true;
    }

    if (a == -1 && isless(aev, bev)) {
      c = -1;
      cev = 1;
      return true;
    }
    ...
    if (0 == a || 0 == b)
    {
      std::cout << "ERROR => Zero edge pointer in lessThan" << std::endl;
      return true;
    }
    return false;
  }
...
class USER_OPS::LessThan_Opname : public MEDDLY::binary_opname
{
public:
  LessThan_Opname() : binary_opname("EVLESSTHAN") {}

  MEDDLY::binary_operation *buildOperation(MEDDLY::expert_forest *arg1,
                                           MEDDLY::expert_forest *arg2,
                                           MEDDLY::expert_forest *res) const
  {
    return new USER_OPS::LessThan(this, arg1, arg2, res);
  }
};

void USER_OPS::initializeLessThan()
{
  USER_OPS::LESSTHAN = new USER_OPS::LessThan_Opname();
}
