...
const MEDDLY::binary_opname *USER_OPS::MULTIPLY;
...
class USER_OPS::Multiply : public MEDDLY::binary_operation
{
public:
  Multiply(const MEDDLY::binary_opname *code, MEDDLY::expert_forest *arg1,
...
protected:
                      ...
                      MEDDLY::node_handle &c)
  {
    ...
    if (0 == a || 0 == b)
    {
      std::cout << "ERROR => Zero edge pointer in multiply" << std::endl;
      return true;
    }
    return false;
  }
...
class USER_OPS::Multiply_Opname : public MEDDLY::binary_opname
{
public:
  Multiply_Opname() : binary_opname("EVMULTIPLY") {}

  MEDDLY::binary_operation *buildOperation(MEDDLY::expert_forest *arg1,
                                           MEDDLY::expert_forest *arg2,
                                           MEDDLY::expert_forest *res) const
  {
    return new USER_OPS::Multiply(this, arg1, arg2, res);
  }
};

void USER_OPS::initializeMultiply()
{
  USER_OPS::MULTIPLY = new USER_OPS::Multiply_Opname();
}
