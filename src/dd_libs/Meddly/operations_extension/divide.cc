...
const MEDDLY::binary_opname *USER_OPS::DIVIDE;
...
class USER_OPS::Divide : public MEDDLY::binary_operation
{
public:
  Divide(const MEDDLY::binary_opname *code, MEDDLY::expert_forest *arg1,
...
protected:
                      ...
                      MEDDLY::node_handle &c)
  {
    ...
    if (0 == a || 0 == b)
    {
      std::cout << "ERROR => Zero edge pointer in divide" << std::endl;
      return true;
    }
    return false;
  }
...
class USER_OPS::Divide_Opname : public MEDDLY::binary_opname
{
public:
  Divide_Opname() : binary_opname("EVDIVIDE") {}

  MEDDLY::binary_operation *buildOperation(MEDDLY::expert_forest *arg1,
                                           MEDDLY::expert_forest *arg2,
                                           MEDDLY::expert_forest *res) const
  {
    return new USER_OPS::Divide(this, arg1, arg2, res);
  }
};

void USER_OPS::initializeDivide()
{
  USER_OPS::DIVIDE = new USER_OPS::Divide_Opname();
}
