...
SimpleSymSolutionCut::SimpleSymSolutionCut(int g, int h, BDD cut, BDD visited_states) 
: SymSolutionCut(g, h, cut), visited_states(visited_states) {}

SimpleSymSolutionCut::SimpleSymSolutionCut(SymSolutionCut cut, BDD visited_states) 
: SymSolutionCut(cut.get_g(), cut.get_h(), cut.get_cut()), visited_states(visited_states) {}
