...
namespace symbolic {
    ...
    void SymPlanReconstructor::extract_all_plans(SymSolutionCut &sym_cut, bool fw, Plan plan) {
    ...
    void SymPlanReconstructor::extract_all_zero_plans(SymSolutionCut &sym_cut, bool fw, Plan &plan) {
        BDD intersection;
