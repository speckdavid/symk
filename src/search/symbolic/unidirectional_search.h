...
namespace symbolic {
	...
	virtual std::vector<SymSolution> getAllCuts(UnidirectionalSearch *search, const Bdd &states, int g, bool fw, int lower_bound) const = 0;
	...
	virtual std::vector<SymSolution> getAllCuts(UnidirectionalSearch *search, const Bdd &states, int g, bool fw, int lower_bound) const override;
